...
➡️사용자가 읽는 도서 장르(카테고리) 추려내기: top 3까지 조회   
member-Mapper.xml
```
...
사용자가 읽은 도서가 있을 경우, 읽은 도서의 카테고리를 조회하여 나온 결과의 도서를 랜덤 추천합니다. 읽은 도서는 추천하지 않습니다.   
...
### 🍀팀으로 협업하면서 느낀 점
각자 할 것에 집중하다 보니 의사소통의 때를 놓칠 때가 종종 있었습니다. 형상 관리 툴로 SVN을 사용하면서 의사소통을 꼼꼼히 하기 시작하였습니다. 또 직접적 의사소통이 아닌 코드를 통한 간접적 의사소통의 중요함 또한 알게 되었습니다. 여기서 간접적 의사소통이란 팀원이 맡은 모듈의 코드를 읽거나 재사용할 때 누가 봐도 알아보기 쉽도록 주석을 잘 달아 두는 것을 의미합니다.
...
### 💭게시글을 마치며
프로젝트를 진행하면서 직면한 문제와 그 해결 방법을 꼼꼼하게 적어두면 좋았을 것 같다. 다음 프로젝트는 이 점을 유의해서 더 좋은 결과물과 더 성장한 나를 만들고 싶다. (220605)   
jQuery를 사용했지만 요즘 잘 쓰지 않는 추세라고 하니 다른 것을 사용해 보고 싶다. 예를 들면 React라든가... React라든가... React 같은 거. 최근에 받아보기 시작한 IT 뉴스레터에 풀스택 개발자들이 2022년에 꼭 배워야 하는 언어 1위가 리액트였다. 일단 스프링부트 강의 들으면서 자바 복습하고 그 다음엔 리액트 공부 찍먹 해 봐야지. (220606)
